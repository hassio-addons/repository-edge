...
- ⬆ Upgrades binutils to 2.30-21ubuntu1~18.04.5 (#170) 
- ⬆ Bump actions/stale from v3.0.16 to v3.0.17 (#167) 
- ⬆️ Bump docker/build-push-action from v2.2.2 to v2.3.0 (#163)
...
- Upgrade add-on base image to 6.1.3 (#165) 
- ⬆️ Bump release-drafter/release-drafter from v5.13.0 to v5.14.0 (#161)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆ Upgrades openjdk-8-jdk-headless to 8u282-b08-0ubuntu1~18.04 (#164) 
- ⬆️ Bump frenck/action-addon-linter from v1.4 to v2 (#160)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump actions/stale from v3.0.15 to v3.0.16 (#158)
