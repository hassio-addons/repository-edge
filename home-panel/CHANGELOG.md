...
- ⬆️ Bump actions/cache from v2.1.4 to v2.1.5 (#102)
...
- ⬆️ Bump docker/setup-buildx-action from v1.1.1 to v1.1.2 (#100)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump docker/setup-qemu-action from v1.0.1 to v1.0.2 (#99)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump docker/build-push-action from v2.3.0 to v2.4.0 (#98)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Upgrades add-on base image to v9.1.6 (#97) 
