...
Your collection stays where it is. Audiobookshelf reads the folders you give it
under `media` and `share` and never moves or rewrites what is in them.
...
[release-shield]: https://img.shields.io/badge/version-ebace93-blue.svg
[release]: https://github.com/hassio-addons/app-audiobookshelf/tree/ebace93