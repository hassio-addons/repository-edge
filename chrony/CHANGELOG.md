...
- Apply updated repository structure & CI workflow (#60) 
- Bump docker/setup-buildx-action from v1.2.0 to v1.3.0 (#59)
...
- Bump docker/login-action from v1.8.0 to v1.9.0 (#58)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- Bump docker/setup-qemu-action from v1.0.2 to v1.1.0 (#57)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- Bump docker/setup-buildx-action from v1.1.2 to v1.2.0 (#56)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- Upgrades add-on base image to v9.2.0 (#55) 
- Bump brpaz/hadolint-action from v1.3.1 to v1.4.0 (#54)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- Bump actions/cache from v2.1.4 to v2.1.5 (#53)
