...
- Add translation support (#90) 
- Apply updated repository structure & CI workflow (#89) 
- ⬆️ Bump docker/setup-buildx-action from v1.2.0 to v1.3.0 (#88)
...
- ⬆️ Bump docker/login-action from v1.8.0 to v1.9.0 (#87)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump docker/setup-buildx-action from v1.1.2 to v1.2.0 (#86)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump docker/setup-qemu-action from v1.0.2 to v1.1.0 (#85)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- Upgrades add-on base image to v6.2.0 (#83) 
- ⬆️ Bump brpaz/hadolint-action from v1.3.1 to v1.4.0 (#82)
