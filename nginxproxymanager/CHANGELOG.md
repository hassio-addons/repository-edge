...
- ⬆️ Upgrades NGINX Proxy Manager to v2.8.1 (#175) 
- ⬆️ Upgrades python3 to 3.8.8-r0 (#174) 
- ⬆️ Bump release-drafter/release-drafter from v5.14.0 to v5.15.0 (#172)
...
- ⬆️ Upgrades git to 2.30.2-r0 (#173) 
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆ Upgrades python3 to 3.8.7-r1 (#162) 
- ⬆️ Bump actions/stale from v3.0.16 to v3.0.17 (#161)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump docker/build-push-action from v2.2.2 to v2.3.0 (#159)
...
- ⬆️ Bump release-drafter/release-drafter from v5.13.0 to v5.14.0 (#158)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump frenck/action-addon-linter from v1.4 to v2 (#154)
