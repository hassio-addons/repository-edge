...
- Upgrade add-on base image to 9.1.4 (#126) 
- ⬆ Upgrades python3 to 3.8.7-r1 (#125) 
...
- ⬆️ Bump docker/build-push-action from v2.2.2 to v2.3.0 (#123)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump release-drafter/release-drafter from v5.13.0 to v5.14.0 (#122)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump actions/stale from v3.0.15 to v3.0.16 (#120)
