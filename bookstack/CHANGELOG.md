# Changelog since v0.8.5
- Bump docker/setup-qemu-action from v1.0.1 to v1.0.2 (#70)
...
- Bump docker/setup-buildx-action from v1.1.1 to v1.1.2 (#69)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- Bump docker/build-push-action from v2.3.0 to v2.4.0 (#68)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- Bump ludeeus/action-shellcheck from 1.0.0 to 1.1.0 (#67)
