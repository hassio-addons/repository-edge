...
- ⬆️ Upgrades add-on base image to v9.1.7 (#57) 
- ⬆️ Bump docker/setup-qemu-action from v1.0.1 to v1.0.2 (#56)
...
- ⬆️ Bump docker/setup-buildx-action from v1.1.1 to v1.1.2 (#55)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump ludeeus/action-shellcheck from 1.0.0 to 1.1.0 (#53)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> 
- ⬆️ Bump actions/stale from v3.0.17 to v3.0.18 (#46)
